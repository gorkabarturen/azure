...
static const char* deviceId = "raio";
static const char* connectionString = "HostName=testraioa8dad.azure-devices.net;DeviceId=raio;SharedAccessKey=R33VOHE+f2VMkuzg0dG4X8Wp3ZYwCoix8U/9iZB46SQ=";
...
void remote_monitoring_run(void)
{
  if (platform_init() != 0)
	...
	{
	  printf("Intentando crear la conexion \n ");
